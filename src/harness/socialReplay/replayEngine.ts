import { contiguousParallelBatch, formatRange, isParallelEnvironment, numericRange, sameOptionalRange } from "./support";
import { compareSocialDomainAdapterManifests, type SocialDomainAdapterManifest } from "../domainAdapter";
import { type SocialEpisodeReplayResult, type SocialRecordedAgentStateValidator, type SocialRecordedStepValidator } from "./contracts";
import { auditRecordedSocialAgentSnapshots, type HarnessAgentSnapshotFrame, resolveHarnessAgentSnapshotFrame } from "../episodeArtifacts";
import { deriveSocialExposureRecords, isSocialParallelJointStep, isSocialStepCommitted, isSocialStepNonReplayableFailure, SocialCommunicationBus, type SocialEnvironment, type SocialEpisodeArtifact, type SocialHarnessStep, type SocialMessage, validateSocialEpisodeArtifact, validateSocialParallelBatchLayout } from "../social";
