  ...
  return (
    <Flex vertical gap="middle" data-testid="werewolf-live-board" aria-live="polite">
      <Alert
        ...
        message="实时公开局面 · 服务端权威"
        description="仅显示服务端在已提交边界投影的公开桌面事实。夜间私密行动、角色、阵营、调度节奏、Agent 记忆与推理均不在此视图中。"
      />
      ...
      <Card title="公开局面概览" bordered={false}>
        <Descriptions size="small" column={{ xs: 1, sm: 2, lg: 4 }}>
          ...
          <Descriptions.Item label="投影来源">服务端已提交边界</Descriptions.Item>
        </Descriptions>
      </Card>
      ...
      <section aria-label="狼人杀实时公开座位">
        <Card
          title="公开座位"
          extra={<Tag color="blue" icon={<EyeInvisibleOutlined />}>仅公开事实</Tag>}
          bordered={false}
        >
          <div role="list">
            <Row gutter={[12, 12]}>
  ...
  return (
    <Flex vertical gap="small">
      {votes.map((vote, index) => (
        <Card key={`${vote.day}-${vote.voterId}-${index}`} size="small">
          <Space wrap>
